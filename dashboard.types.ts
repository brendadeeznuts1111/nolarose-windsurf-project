...
interface DashboardConfig {
  theme: "dark" | "light" | "high-contrast" | "enterprise-blue" | "family-purple";
  refreshRate: number;
...
function createDashboardConfig(overrides: Partial<DashboardConfig> = {}): DashboardConfig {
  return {
    ...defaultConfig,
    ...overrides,
...
function validateConfig(config: DashboardConfig): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
