#!/usr/bin/env bun
// Family Controls API Server - Guardian-Powered Teen Onboarding Endpoints
...
console.log('🛡️ Family Controls API Server running on port 3002');
...
console.log('  GET  /api/family/coppa/compliance/:id - Check COPPA compliance');
