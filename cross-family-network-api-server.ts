#!/usr/bin/env bun
// Cross-Family Guardian Networks API Server - Graph-Based Sponsorship Webs
...
console.log('🕸️ Cross-Family Guardian Networks API Server running on port 3004');
...
console.log('  PUT  /api/family/settings/:id - Update network settings');
console.log('  GET  /api/family/activity/:id - Get network activity');
console.log('  GET  /api/family/alerts/:id - Get network alerts');
console.log('  POST /api/family/batch/links - Batch add links');
